    ...
    <div class="text-center w-100">
        ...
        <div class="card mx-auto shadow-lg border-0" 
            ...
            <div class="card-header bg-primary text-white text-center" style="padding: 15px;">
                <h4>Register as Lecturer</h4>
            </div>
            <div class="card-body px-5 py-4"> <!-- Padding lebih proporsional -->
                <form action="{{ route('teacher.register') }}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control form-control-lg" name="nip" placeholder="Enter your NIP" required>
                    </div>
                    <div class="mb-3">
